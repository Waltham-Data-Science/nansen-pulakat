    ...
    methods (Static)
        ...
        function info = projectInfo()
            ...
            info.subjectFileColumns = [ ...
                makeColumn('Animal',               'AnimalID',     'ontologyTableRow'); ...
                makeColumn('Cage',                 'CageID',       'ontologyTableRow'); ...
                makeColumn('Label',                'AnimalLabel',  'ontologyTableRow'); ...
                makeColumn('Species',              'SpeciesName',  'metadata'); ...
                makeColumn('Strain',               'StrainName',   'metadata'); ...
                makeColumn('BiologicalSex',        'SexName',      'metadata'); ...
                makeColumn('Treatment',            'TreatmentName','ontologyTableRow') ...
            ];

            info.dataFileColumns = [ ...
                makeColumn('DataTypeName',         'DataTypeName', 'metadata'); ...
                makeColumn('ElectronicFileName',   'FileName',     'ontologyTableRow') ...
            ];

...
methods
    function [subjectIdentifier, strain, species, biologicalSex] = create(obj, tableRow)
        ...
        if ~isempty(missingColumns)
            error('NDI:Nansen:Import:Subject:MissingRequiredColumns', ...
                ['[NDI:Nansen:Import:Subject:MissingRequiredColumns] The ' ...
                 'subject table for the %s lab is missing required ' ...
                 'column(s): %s.\nExpected columns: %s.'], ...
...
methods (Access = private, Static)
    function selectedStrainInfo = getStrainInfo(tableRow)
        ...
        if isempty(tableRow.StrainName{1})
            error('NDI:Nansen:Import:Subject:MissingStrain', ...
                ['[NDI:Nansen:Import:Subject:MissingStrain] The strain ' ...
                 'name is missing.']);
        end
        ...
        if ~any(indStrain)
            error('NDI:Nansen:Import:Subject:InvalidStrain', ...
                ['[NDI:Nansen:Import:Subject:InvalidStrain] The strain ' ...
                 '"%s" was not found in the strains configuration file.'], ...
                tableRow.StrainName{1});
        end
    ...
    function species = createSpeciesObject(selectedStrainInfo)
        ...
        try
            ...
            error('NDI:Nansen:Import:Subject:SpeciesCreationFailed', ...
                ['[NDI:Nansen:Import:Subject:SpeciesCreationFailed] Could ' ...
                 'not create openMINDS Species object: %s'], ME.message);
        end
    end
    ...
    function strain = createStrainObject(selectedStrainInfo,species)
        ...
        try
            ...
            error('NDI:Nansen:Import:Subject:StrainCreationFailed', ...
                ['[NDI:Nansen:Import:Subject:StrainCreationFailed] Could ' ...
                 'not create openMINDS Strain object: %s'], ME.message);
        end
    end
    ...
    function biologicalSex = createBiologicalSexObject(tableRow)
        ...
        if isempty(tableRow.BiologicalSexName{1})
            error('NDI:Nansen:Import:Subject:BiologicalSexMissing', ...
                ['[NDI:Nansen:Import:Subject:BiologicalSexMissing] The ' ...
                 'biological sex name is missing.'])
        end
        try
            % Look up ontology information
            [ontologyID,name,~,definition,synonyms] = ...
            ...
            error('NDI:Nansen:Import:Subject:BiologicalSexCreationFailed', ...
                ['[NDI:Nansen:Import:Subject:BiologicalSexCreationFailed] ' ...
                 'Could not create openMINDS BiologicalSex object: %s'], ...
                ME.message);
        end
    end
    ...
    function subjectIdentifier = constructSubjectIdentifier(tableRow,projectInfo)
        ...
        if any(indEmpty)
            error('NDI:Nansen:Import:Subject:MissingSubjectIdentifier', ...
                ['[NDI:Nansen:Import:Subject:MissingSubjectIdentifier] ' ...
        ...
        try
            ...
            error('NDI:Nansen:Import:Subject:IdentifierCreationFailed', ...
                ['[NDI:Nansen:Import:Subject:IdentifierCreationFailed] ' ...
                 'Could not construct the subject identifier string: %s'], ...
                ME.message);
        end
    end

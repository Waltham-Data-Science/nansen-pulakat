...
%       varargin: Optional name-value pairs (currently unused).
    ...
    if nInvalid > 0 || nExisting > 0
        ...
        msg = sprintf([ ...
            ...
            '%d valid subject(s) are ready for document creation.\n\n' ...
            'Edit the invalid subjects first, or create documents ' ...
            'for the ready subjects now?'], ...

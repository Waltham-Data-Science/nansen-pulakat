classdef SubjectEnumeratedIdentifier < nansen.metadata.abstract.TableVariable
%SUBJECTENUMERATEDIDENTIFIER Definition for table variable
...
%   See also nansen.metadata.abstract.TableVariable
    ...
    methods (Static)
        function value = update(varargin)
            ...
            if nargin < 1
                value = pulakat.tablevariable.file.SubjectEnumeratedIdentifier.DEFAULT_VALUE;
                return
            else
